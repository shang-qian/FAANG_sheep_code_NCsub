...
# function： read peak transfer to GRanges
...
write.table(as.data.frame(H3K4me1_annotated), file = paste0(Tisname,"/",Tisname,"_00H3K4me3.Propeak"), sep = "\t", row.names = FALSE, col.names = FALSE, quote = FALSE)
