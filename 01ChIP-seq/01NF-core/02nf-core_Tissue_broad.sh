...
workdir=~/FAANG/analysis/01ChIP-seq/02nfcore_5e3/02Broad
...
mkdir -p $Boutput 
cd $Boutput
nextflow run nf-core/chipseq --input ~/FAANG/analysis/00Sample_info/sample_information/${Tissue}_sample_broad.csv \
